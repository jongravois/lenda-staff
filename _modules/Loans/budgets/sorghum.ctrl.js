(function(){
    ...
    angular
        .module('ARM')
        .controller('SorghumController', SorghumController);

        SorghumController.$inject = ['$rootScope', '$scope', 'AppFactory'];

        function SorghumController($rootScope, $scope, AppFactory){
            $scope.buddy = _.filter($scope.loan.expenses.byEntry, function(e){
                return e.crop === 'sorghum';
            });
