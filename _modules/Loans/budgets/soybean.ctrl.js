(function(){
    ...
    angular
        .module('ARM')
        .controller('SoybeanController', SoybeanController);

        SoybeanController.$inject = ['$rootScope', '$scope', 'AppFactory'];

        function SoybeanController($rootScope, $scope, AppFactory){
            $scope.buddy = _.filter($scope.loan.expenses.byEntry, function(e){
                return e.crop === 'soybeans';
            });
