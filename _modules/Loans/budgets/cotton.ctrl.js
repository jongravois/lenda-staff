(function(){
    ...
    angular
        .module('ARM')
        .controller('CottonController', CottonController);

        CottonController.$inject = ['$rootScope', '$scope', 'AppFactory'];

        function CottonController($rootScope, $scope, AppFactory){
            $scope.buddy = _.filter($scope.loan.expenses.byEntry, function(e){
                return e.crop === 'cotton';
            });
