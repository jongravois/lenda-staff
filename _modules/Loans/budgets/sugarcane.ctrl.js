(function(){
    ...
    angular
        .module('ARM')
        .controller('SugarcaneController', SugarcaneController);

        SugarcaneController.$inject = ['$rootScope', '$scope', 'AppFactory'];

        function SugarcaneController($rootScope, $scope, AppFactory){
            $scope.buddy = _.filter($scope.loan.expenses.byEntry, function(e){
                return e.crop === 'sugarcane';
            });
