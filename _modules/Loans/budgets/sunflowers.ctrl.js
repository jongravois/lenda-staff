(function(){
    ...
    angular
        .module('ARM')
        .controller('SunflowersController', SunflowersController);

        SunflowersController.$inject = ['$rootScope', '$scope', 'AppFactory'];

        function SunflowersController($rootScope, $scope, AppFactory){
            $scope.buddy = _.filter($scope.loan.expenses.byEntry, function(e){
                return e.crop === 'sunflowers';
            });
