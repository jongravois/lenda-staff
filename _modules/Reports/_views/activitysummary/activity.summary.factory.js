(function () {
    ...
    angular
        .module('ARM')
        .factory('ActivitySummaryFactory', ActivitySummaryFactory);

    ActivitySummaryFactory.$inject = [];

    /* @ngInject */
    function ActivitySummaryFactory() {
        var publicAPI = {
            getData: getData
        };
        return publicAPI;
        ...
        function getData(loans) {
            //console.log('ActivitySummaryFactory.loans', loans);
