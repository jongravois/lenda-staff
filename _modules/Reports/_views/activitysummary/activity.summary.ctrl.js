(function () {
    ...
    ActivitySummaryController.$inject = ['$scope', '$http', '$filter', '$timeout', 'AppFactory', 'Loans', 'hotkeys'];

    function ActivitySummaryController($scope, $http, $filter, $timeout, AppFactory, Loans, hotkeys) {
