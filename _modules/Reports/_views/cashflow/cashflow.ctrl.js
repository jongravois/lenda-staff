(function () {
    ...
    CashflowController.$inject = ['$scope', '$http', '$filter', '$timeout', 'AppFactory', 'Loans', 'hotkeys'];

    function CashflowController($scope, $http, $filter, $timeout, AppFactory, Loans, hotkeys) {
