(function () {
    ...
    LoanManagementController.$inject = ['$scope', '$http', '$filter', '$timeout', 'AppFactory', 'Loans', 'hotkeys'];

    function LoanManagementController($scope, $http, $filter, $timeout, AppFactory, Loans, hotkeys) {
