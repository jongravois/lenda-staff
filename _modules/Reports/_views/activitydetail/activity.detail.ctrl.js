(function () {
    ...
    ActivityDetailController.$inject = ['$scope', '$http', '$filter', '$timeout', 'AppFactory', 'Loans', 'hotkeys'];

    function ActivityDetailController($scope, $http, $filter, $timeout, AppFactory, Loans, hotkeys) {
